...
namespace DungeonGraph.Editor
{
    ...
    public static class OrganicGeneration
    {
            ...
            string floorPath = "")
        {
            ...
            */
            ...
            do
            {
                ...
                {
                    // Build adjacency list and prepare data structures for shared simulation utility
                    ...
                    // Call shared simulation utility
        ...
        // Helper method to calculate room radii from instances
